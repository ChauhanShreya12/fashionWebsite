      ...
      if (
        ...
        a.each(w, function (a1) {
          ...
          if (!j.length && a3.length) {
            a4.prepend(
              '<img class="etalage_thumb_image" src="' + a3.attr("src") + '" />'
            );
          } else {
            if (!j.length && !a3.length) {
              a4.remove();
        ...
        var av = w
          ...
          .css({ width: c.thumb_image_width, height: c.thumb_image_height })
          .show();
        a.each(av, function () {
        ...
        var W = K.children("div"),
          an;
        if (ao) {
          an = a('<img class="etalage_zoom_preview" />')
            .css({
        ...
        if (q > 1 || !c.smallthumb_hide_single) {
          aQ = a('<li class="etalage_small_thumbs"><ul></ul></li>').appendTo(
            aG
          );
          l = aQ.children("ul");
          a.each(av, function () {
            ...
            a('<li><img class="etalage_small_thumb" src="' + Q + '" /></li>')
              .data("thumb_id", I)
              .appendTo(l);
          });
          ...
          if (q > aj) {
            if (c.show_begin_end_smallthumb) {
              ...
              a(
                ...
                .data("src", Q)
                .data("thumb_id", I)
                .css({ opacity: c.smallthumb_inactive_opacity })
                .prependTo(l);
              Q = av.eq(0).data("src");
              I = w.eq(0).data("id");
              a(
        ...
        var aN =
            parseInt(w.css("borderLeftWidth"), 10) +
            parseInt(w.css("borderRightWidth"), 10) +
            parseInt(av.css("borderLeftWidth"), 10) +
            parseInt(av.css("borderRightWidth"), 10),
          Z =
            parseInt(w.css("marginLeft"), 10) +
            parseInt(w.css("marginRight"), 10),
          B =
            parseInt(w.css("paddingLeft"), 10) +
            parseInt(w.css("paddingRight"), 10) +
            parseInt(av.css("marginLeft"), 10) +
            parseInt(av.css("marginRight"), 10) +
            parseInt(av.css("paddingLeft"), 10) +
            parseInt(av.css("paddingRight"), 10),
        ...
        if (q > 1 || !c.smallthumb_hide_single) {
          aE =
            parseInt(aV.css("borderLeftWidth"), 10) +
            parseInt(aV.css("borderRightWidth"), 10) +
            parseInt(u.css("borderLeftWidth"), 10) +
            parseInt(u.css("borderRightWidth"), 10);
          ...
          ax =
            ...
            parseInt(u.css("paddingRight"), 10);
          if (aF === "vert") {
        ...
        if (c.show_descriptions) {
          aX =
            parseInt(az.css("borderLeftWidth"), 10) +
            parseInt(az.css("borderRightWidth"), 10);
          at =
            parseInt(az.css("marginLeft"), 10) +
            parseInt(az.css("marginRight"), 10);
          v =
            parseInt(az.css("paddingLeft"), 10) +
            parseInt(az.css("paddingRight"), 10);
          ar = T - aX - at - v;
        }
        var aM;
        if (e) {
        ...
        var g = function (a3, a1) {
          ...
          aG.find(".etalage_thumb_active")
            ...
            .stop()
            .animate({ opacity: 0 }, c.speed, function () {
              a(this).hide();
            });
          j = w
            .filter(".thumb_" + a3.data("thumb_id"))
            .addClass("etalage_thumb_active")
            .show()
            .stop()
            .css({ opacity: 0 })
            .animate({ opacity: 1 }, c.speed);
        ...
        w.add(aO)
          ...
          .mousemove(function (a5) {
            ...
            Y = -(
              (a4 - am) *
              (1 / (c.thumb_image_width / c.source_image_width))
            );
            X = -(
              (a3 - aK) *
              (1 / (c.thumb_image_height / c.source_image_height))
            );
            if (Y < aU) {
              Y = aU;
            }
            ...
            if (!a7.hasClass("etalage_smallthumb_active") && (!ai || z)) {
              if (a7.hasClass("etalage_smallthumb_first") && a7.prev().length) {
                ...
                if (a7.hasClass("etalage_smallthumb_navtoend")) {
                  ...
                  if (
                    a7.hasClass("etalage_smallthumb_last") &&
                    a7.next().length
                  ) {
                    aP("right");
                  } else {
